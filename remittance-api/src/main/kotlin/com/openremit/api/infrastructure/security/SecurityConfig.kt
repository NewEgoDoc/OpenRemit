...
class SecurityConfig {
    ...
    @Bean
    fun jwtSecretKey(properties: JwtProperties): javax.crypto.SecretKey {
    ...
    @Bean
    fun jwtEncoder(jwtSecretKey: javax.crypto.SecretKey): JwtEncoder =
        NimbusJwtEncoder(ImmutableSecret(jwtSecretKey))

    @Bean
    fun jwtDecoder(jwtSecretKey: javax.crypto.SecretKey): JwtDecoder =
